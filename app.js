...
var _VueAutocompletePlaces = __webpack_require__(6);

var _VueAutocompletePlaces2 = _interopRequireDefault(_VueAutocompletePlaces);
...
var app = new _vue2.default({
    ...
    components: { VueAutocompletePlaces: _VueAutocompletePlaces2.default },
...
var CITIES_TYPE = ['cities', 'locality', 'administrative_area_level_3'];
...
exports.default = {
    ...
    watch: {
        placeServiceText: function placeServiceText(newVal, oldVal) {
            this.$emit('inputChange', { newVal: newVal, oldVal: oldVal }, this.id);
        },
        country: function country(newVal, oldVal) {
            this.placeService.setComponentRestrictions({
    ...
    mounted: function mounted() {
        ...
        this.placeService.addListener('place_changed', this.onPlaceChanged);
    },
    ...
    methods: {
        ...
        onPlaceChanged: function onPlaceChanged() {
            var place = this.placeService.textSearch({
                type: 'airport',
                radius: 500000
            });
            console.log(place);
            ...
            if (place.address_components !== undefined) {
                ...
                // update placeServiceText then emit change event
                this.placeServiceText = document.getElementById(this.id).value;
                console.log('placeServiceText');
                console.log(this.placeService);
                this.onChange();
            }
        },
        ...
        onChange: function onChange() {
            this.$emit('change', this.placeServiceText);
        },
        ...
        // Bias the placeService object to the user's geographical location,
        // as supplied by the browser's 'navigator.geolocation' object.
        biasplaceServiceLocation: function biasplaceServiceLocation() {
            var _this4 = this;
            ...
            if (this.enableGeolocation) {
                this.updateGeolocation(function (geolocation, position) {
                    ...
                    _this4.placeService.setBounds(circle.getBounds());
                });
            }
        },
...
Component.options.__file = "C:\\Users\\felip\\Documents\\Projects\\vue-google-autocomplete\\src\\VueAutocompletePlaces.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] VueAutocompletePlaces.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7c8c7612", Component.options)
  } else {
    hotAPI.reload("data-v-7c8c7612", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.placeServiceText),
      expression: "placeServiceText"
    }],
    ref: "placeService",
    class: _vm.classname,
    attrs: {
    ...
    on: {
      ...
      "input": function($event) {
        ...
        _vm.placeServiceText = $event.target.value
      }
    }
  })
},staticRenderFns: []}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7c8c7612", module.exports)
  }
}
